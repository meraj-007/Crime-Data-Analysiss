...
def root():
	...
	return render_template('homepg.html',markers=markers )
...
@app.route('/analysisCrimeAgainstWomen.html')
def analysisCrimeAgainstWomen():
	return render_template('analysisCrimeAgainstWomen.html')

@app.route('/analysisMurder.html')
def analysisMurder():
	return render_template('analysisMurder.html')

@app.route('/analysisTheft.html')
def analysisTheft():
	return render_template('analysisTheft.html')

@app.route('/crimeAnalysis.html')
def CrimeAnalysis():
	return render_template('crimeAnalysis.html')

	
@app.route('/raipurComplete.html')
def raipurComplete():
	return render_template('raipurComplete.html')

@app.route('/enterCrime.html')
def enterCrime():
	return render_template('enterCrime.html')

@app.route('/predictCrime.html')
def predictCrime():
	return render_template('predictCrime.html')
